...
import { AutomationParametersList } from '../components/automations/AutomationParametersList';
import { supabase } from '../lib/supabase';
import { useAuth } from '../hooks/useAuth';
import { formatDate } from '../lib/utils';
import { Automation } from '../lib/types';
import { Plus, Edit2, Trash2, Save, X, Settings, Sliders } from 'lucide-react';
...
export function AutomationManager() {
  ...
  const [activeTab, setActiveTab] = useState<'automations' | 'settings' | 'automation-params'>('automations');
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === 'automations' ? (
        ...
        <AutomationParametersList automations={automations} />
      ) : (
        <SettingsManager 
          category="automation" 
          title="Paramètres globaux des automatisations" 
        />
      )}
    </div>
  );
